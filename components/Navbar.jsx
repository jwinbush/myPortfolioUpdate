...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full h-20 z-10 fixed backdrop-blur-	 text-black duration-300 ease-in ${
        pageScroll && "bg-black bg-opacity-80 text-[#fff]"
      }`}
    >
      <div className="flex justify-between items-center w-full h-full max-w-screen-xl mx-auto p-4">
        <Link href="/#home">
          <h1 className="text-3xl lg:text-4xl font-bold uppercase tracking-wider cursor-pointer">
        <span className="text-transparent bg-clip-text bg-gradient-to-r via-red-600 from-orange-400 to-red-500">wΦn</span>
          </h1>
        </Link>
        ...
        >
          <div>
            <div className="flex w-full items-center ">
              ...
              <div
                onClick={() => setNavigation(false)}
                className="p-3 cursor-pointer ml-40"
              >
                <FaTimes size={30} />
              </div>
            </div>
